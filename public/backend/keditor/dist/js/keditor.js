...
(function ($) {
    ...
    KEditor.DEFAULTS = {
        ...
        snippetsUrl: asset_url+'backend/keditor/sample/snippets/snippets.html',
    ...
    KEditor.prototype.renderSnippets = function (resp) {
        ...
        $('<div />').html(resp).find('> div').each(function (i) {
            ...
            snippetHtml += '   <img class="keditor-ui keditor-snippet-preview" src="' +asset_url+'backend/keditor/sample/previewUrl + '" />';
            snippetHtml += '</section>';
