(function ($) {
    ...
    function initToolbar() {
        ...
        var btnViewSave = $('<button type="button" class="view-source"><i class="fa fa-code"></i> View source</button>');
        var btnViewPreview = $('<button type="button" class="view-source"><i class="fa fa-code"></i> View source</button>');
