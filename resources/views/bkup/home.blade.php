    ...
    <div id="banner_carousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item <?php echo ($key == 0) ? 'active' : ''; ?>">
                <!-- <img src="{{ imageUrl(asset(Storage::disk('local')->url($banner->banners_image)), 1498, 681, 100, 1)}}" alt="First slide" />-->
                <!--<img src="{{ url('/'). resize(base_path('public').Storage::disk('local')->url($banner->banners_image), array('w'=>1498,'h'=>681), 1) }}" alt="slide <?=$key?>" />-->
                <img src="{{ url('/').base_path('public').Storage::disk('local')->url($banner->banners_image) }}" alt="slide <?=$key?>" />
