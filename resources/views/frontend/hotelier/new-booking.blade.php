                ...
                <div class="tab-pane active" role="tabpanel" id="step1">
                    <form id="hotelierBookingForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group selectRoomType"></div>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on('change', '.roomType', function(e) {
            $('#roomDisc').val('0');
            $('#selectedRoomType').val($(this).attr('data-name'));
            $('#roomPrc').val($(this).val());
            $('#roomFnlPrc').val($('#bookingNights').val() *  parseFloat($(this).val()) * parseFloat($('#noOfRoomReq').val()));
        });
