      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Add New Room Facilities
          ...
          <div class="card-body">
            ...
            <form id="AddNewRoomFacility" method="post" action="{{ route('admin.room_facilities.doadd') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
