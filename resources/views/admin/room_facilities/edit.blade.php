      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Room Facilities
            <div class="float-right">
              <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                <?php @langOption(); ?>
              </select>
              <a href="{{ route('admin.room_facilities')}}" class="btn-sm btn-success btn-round ">
          ...
          <div class="card-body">
            ...
            <form id="EditRoomFacility" method="post" action="{{ route('admin.room_facilities.update', ['id' => $roomfacility->id]) }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="{{ $roomfacility->name }}">
                  </div>
                 
                  <div class="form-group">
                    <label class="bmd-label-floating">Status</label>
                    <select id="status" name="status" class="form-control">
                      <option value="1" @if($roomfacility->status == 1) selected @endif>Published</option>
                      <option value="2" @if($roomfacility->status == 2) selected @endif>Draft</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
