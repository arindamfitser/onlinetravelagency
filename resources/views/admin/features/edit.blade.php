      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Features
              <div class="float-right">
                <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                  <?php @langOption(); ?>
                </select>
                <a href="{{ route('admin.features')}}" class="btn-sm btn-success btn-round ">
            ...
            <div class="card-body">
              ...
              <form id="EditFeatures" method="post" action="{{ route('admin.features.update', ['id' => $keyfeature->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group">
                      ...
                      <input type="text" id="name" name="name" class="form-control" value="{{ $keyfeature->name }}">
                    </div>
                    <div class="form-group">
                      ...
                      <div class="file-field">
                        <div class="z-depth-1-half mb-4">
                          @if($keyfeature->icons)
                          <img src="{{ Storage::disk('local')->url('public/uploads/icons/'.$keyfeature->icons) }}" class="img-fluid" alt="example placeholder">
                          @endif
                        </div>
                        <div class="d-flex">
                    ...
                    <div class="form-group">
                      ...
                      <select id="status" name="status" class="form-control">
                        <option value="1" @if($keyfeature->status == 1) selected @endif>Published</option>
                        <option value="2" @if($keyfeature->status == 2) selected @endif>Draft</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
