      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Add New Partner
          ...
          <div class="card-body">
            ...
            <form id="AddNewPartner" method="post" action="{{ route('admin.partners.doadd') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" id="partner_title" name="partner_title" class="form-control">
                  </div>
                   <div class="form-group">
