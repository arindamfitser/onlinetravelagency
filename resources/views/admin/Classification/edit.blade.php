      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Classification
            <div class="float-right">
              <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                <?php @langOption(); ?>
              </select>
              <a href="{{ route('admin.classification')}}" class="btn-sm btn-success btn-round ">
          ...
          <div class="card-body">
            ...
            <form id="EditClassification" method="post" action="{{ route('admin.classification.update', ['id' => $classification->id]) }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <input type="hidden" id="lang_code" name="locale" value="en">
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    <label class="bmd-label-floating">Classification Name</label>
                    <input type="text" id="name" name="name" class="form-control" value="{{ $classification->name }}">
                  </div>         
                </div>
                <div class="col-md-2">
                  <!-- right section -->
