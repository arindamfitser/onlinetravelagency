      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Add New Service & Facilities
          ...
          <div class="card-body">
            ...
            <form id="AddNewService" method="post" action="{{ route('admin.service_facilities.doadd') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
