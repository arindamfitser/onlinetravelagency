                      ...
                      <div class="col-md-12"> 
                        <div class="card">
                            ...
                            <div class="card-header card-header-primary">
                              <h3 class="card-title">Edit Banner
                                <div class="float-right">
                                  <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                                    <?php @langOption(); ?>
                                  </select>
                                    <a href="{{ route('admin.banners')}}" class="btn-sm btn-success btn-round "> 
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                      <div class="form-group">
                                          ...
                                          <input type="text" id="banners_title" name="banners_title" class="form-control" value="{{ $banner->banners_title }}">
                                      </div>
                                      <div class="form-group">
                                       <label class="bmd-label-floating">Banner Content</label>
                                         <textarea id='edit' class="form-control" name="banners_description">
                                          {{ $banner->banners_description }}
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                                          <label class="bmd-label-floating">Banner Link</label>
                                          <input type="text" id="banners_link" name="banners_link" class="form-control" value="{{ $banner->banners_link }}">
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="file-field">
                                        <div class="z-depth-1-half mb-4">
                                          ...
                                          <img src="{{ Storage::disk('local')->url($banner->banners_image) }}" class="img-fluid" alt="example placeholder" width="300px" height="200px">
                                          @endif
                                        </div>
                                        <div class="d-flex">
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <label class="bmd-label-floating">Banner Status</label>
                                        <select id="status" name="status" class="form-control">
                                            <option value="1" @if($banner->status == 1) selected @endif>Published</option>
                                            <option value="2" @if($banner->status == 2) selected @endif>Draft</option>
                                        </select>
                                    </div>
                                    </div> 
                                </div>
