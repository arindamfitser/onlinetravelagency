      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Add New Banner
          ...
          <div class="card-body">
            ...
            <form id="AddNewBanner" method="post" action="{{ route('admin.banners.doadd') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" id="banners_title" name="banners_title" class="form-control">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="banners_link" name="banners_link" class="form-control">
                  </div>
                  <div class="form-group">
