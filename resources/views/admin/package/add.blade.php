      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Add New Package
            <div class="float-right">
              <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                <?php @langOption(); ?>
              </select>
              <a href="{{ route('admin.hotels.packages', ['id' => $id]) }}" class="btn-sm btn-success btn-round ">
          ...
          <div class="card-body">
            ...
            <form id="AddNewPackage" method="post" action="{{ route('admin.hotels.packages.do_add', ['id' => $id]) }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id='edit' class="form-control" name="pkg_descp">
                    </textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="pkg_price" name="pkg_price" class="form-control">
                  </div>
                </div>
                <div class="col-md-2">
                </div>
...
<script type="text/javascript">
    $('form[id="AddNewPackage"]').validate({
    rules: {
      pkg_name: {
        required: true
      },
