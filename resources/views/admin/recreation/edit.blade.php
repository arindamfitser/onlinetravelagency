      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Recreation
            <div class="float-right">
              <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                <?php @langOption(); ?>
              </select>
              <a href="{{ route('admin.recreation')}}" class="btn-sm btn-success btn-round ">
          ...
          <div class="card-body">
            ...
            <form id="EditRecreation" method="post" action="{{ route('admin.recreation.update', ['id' => $recreation->id]) }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="{{ $recreation->name }}">
                  </div>
                 
                  <div class="form-group">
                    <label class="bmd-label-floating">Status</label>
                    <select id="status" name="status" class="form-control">
                      <option value="1" @if($recreation->status == 1) selected @endif>Published</option>
                      <option value="2" @if($recreation->status == 2) selected @endif>Draft</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
