      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Experiences
              <div class="float-right">
                <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                  <?php @langOption(); ?>
                </select>
                <a href="{{ route('admin.experiences')}}" class="btn-sm btn-success btn-round ">
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group">
                      ...
                      <input type="text" id="experiences_name" name="experiences_name" class="form-control" value="{{ $experience->experiences_name }}">
                    </div>
                    <div class="form-group">
                      ...
                      <div class="file-field">
                        <div class="z-depth-1-half mb-4">
                          ...
                          <img src="{{ Storage::disk('local')->url($experience->experiences_image) }}" class="img-fluid" alt="example placeholder" width="300px" height="200px">
                          @endif
                        </div>
                        <div class="d-flex">
                    ...
                    <div class="form-group">
                      ...
                      <select id="status" name="status" class="form-control">
                        <option value="1" @if($experience->status == 1) selected @endif>Published</option>
                        <option value="2" @if($experience->status == 2) selected @endif>Draft</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
