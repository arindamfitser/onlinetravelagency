      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Inspirations
            <div class="float-right">
              <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                <?php @langOption(); ?>
              </select>
              <a href="{{ route('admin.inspirations')}}" class="btn-sm btn-success btn-round ">
                ...
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    <label class="bmd-label-floating">Inspirations Status</label>
                      ...
                      <option value="1" @if($inspiration->status == 1) selected @endif>Published</option>
                      <option value="2" @if($inspiration->status == 2) selected @endif>Draft</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
