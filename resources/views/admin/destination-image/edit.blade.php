      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Destination Image
              <div class="float-right">
                <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                  <?php @langOption(); ?>
                </select>
                <a href="{{ route('admin.destination.image')}}" class="btn-sm btn-success btn-round ">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('admin.destination.image.do.edit', ['id' => $image->id]) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group">
                      <label class="bmd-label-floating">Destination Image</label>
                      <div class="file-field">
                        <div class="z-depth-1-half mb-4">
                          @if($image->image)
                          <img src="{{ url('/public').Storage::disk('local')->url('uploads/destination-image/'.$image->image) }}" style="height: 200px;" class="img-fluid" alt="example placeholder">
                          @endif
                        </div>
                        <div class="d-flex">
