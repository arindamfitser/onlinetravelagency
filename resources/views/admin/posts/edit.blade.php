                        ...
                        <div class="col-md-12">
                          <div class="card">
                            ...
                            @include('admin.layouts.messages')
                              <form id="updatePost" method="post" action="{{ route('admin.posts.update') }}">
                                ...
                                <div class="row">
                                  <div class="col-md-7">
                                    <div class="form-group">
                                      ...
                                      <div>Post slug: <span id="post_slug_lebel">{{$post->post_slug}}</span></div> 
                                    ...
                                    <div class="form-group float-right">
                                      <label class="bmd-label-floating">Post Status</label>
                                        <select id="status" name="status" class="browser-default   custom-select">
                                            ...
                                            <option value="3" {{ $post->status == "3" ? "selected" : "" }}>De-active</option>
                                        </select>
                                    </div>
                                  </div>
