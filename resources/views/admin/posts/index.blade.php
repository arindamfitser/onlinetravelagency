                                    ...
                                    <tr>
                                        ...
                                        <td class="text-primary">
                                           ...
                                           <a href="{{ route('admin.posts.edit', ['lang' => $post->locale, 'id' => $post->id]) }}">
                                             ...
                                             @if($post->status==1)
                                              <a href="{{ route('admin.posts.change', ['lang' => $post->locale, 'id' => $post->id,'st' => '2']) }}" style="color:#4caf50">
                                                 <i  class="fa fa-toggle-on" aria-hidden="true"></i>
                                             </a>
                                             @else
                                             <a href="{{ route('admin.posts.change', ['lang' => $post->locale, 'id' => $post->id,'st' => '1']) }}" style="color:red">
                                                 <i class="fa fa-toggle-off" aria-hidden="true"></i>
                                             </a>
                                             @endif
                                            <a href="{{ route('admin.posts.del', ['lang' => 'en', 'id' => $post->id ]) }}">
