                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-primary">
                                 ...
                                 <a href="{{ route('admin.accommodations.status', ['id' => $accommodation->id,'status' => '2']) }}" style="color:#4caf50" title="Published">
                                     <i  class="fa fa-toggle-on" aria-hidden="true"></i>
                                 </a>
                                 @else
                                 <a href="{{ route('admin.accommodations.status', ['id' => $accommodation->id,'status' => '1']) }}" style="color:red" title="Draft">
