      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Add New Country
          ...
          <div class="card-body">
            ...
            <form id="AddNewCountry" method="post" action="{{ route('admin.countries.doadd') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" id="countries_name" name="countries_name" class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="bmd-label-floating">Country Sortcode</label>
                    <input type="text" id="countries_sortname" name="countries_sortname" class="form-control">
                  </div>
                  <div class="form-group">
                    <label class="bmd-label-floating">Phonecode</label>
                    <input type="text" id="countries_phonecode" name="countries_phonecode" class="form-control">
                  </div>
                </div>
                <div class="col-md-2">
