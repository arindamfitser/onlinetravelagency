                    ...
                    <div class="wizard">
                        <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="address" name="address" class="form-control requiredCheck" data-check="Hotel Address" value="{{ $hotels->address }}">
                                            </div>
                                            <div class="form-group">
                                                <div id="map"></div>
                                                ...
                                                <input type="hidden" name="latitude" id="latitude" value="@if(isset($hotels->latitude)){{ $hotels->latitude }}@else {{ '' }}@endif">
                                                <input type="hidden" name="longitude" id="longitude" value="@if(isset($hotels->longitude)){{ $hotels->longitude }}@else {{ '' }}@endif">
                                                <input type="hidden" name="street_number" id="street_number" value="@if(isset($hotels->street_number)){{ $hotels->street_number }}@else {{ '' }}@endif">
                                                <input type="hidden" name="route" id="route" value="@if(isset($hotels->route)){{ $hotels->route }}@else {{ '' }}@endif">
                                                <input type="hidden" name="locality" id="locality" value="@if(isset($hotels->city)){{ $hotels->city }}@else {{ '' }}@endif">
                                                <input type="hidden" name="administrative_area_level_1" id="administrative_area_level_1" value="@if(isset($hotels->state)){{ $hotels->state }}@else {{ '' }}@endif">
                                                <input type="hidden" name="country" id="country" value="@if(isset($hotels->country)){{ $hotels->country }}@else {{ '' }}@endif">
                                                <input type="hidden" name="postal_code" id="postal_code" value="@if(isset($hotels->zip_code)){{ $hotels->zip_code }}@else {{ '' }}@endif">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mailing_address" id="mailing_address" class="form-control requiredCheck" data-check="Mailing Address" value="{{ $hotels->mailing_address }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div id="two" class="tab-pane fade">
                                <form action="{{ route('admin.hotels.update.new', ['id' => $hotels->id]) }}" method="POST"
                                    enctype="multipart/form-data" id="tabTwoEditHotel">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="hotels_desc"
                                                    id="hotels_desc">{{ $hotels->hotels_desc }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Brief Description</label>
                                                <textarea class="form-control ckeditor" name="brief_descp"
                                                    id="brief_descp">{{ $hotels->brief_descp }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Do you have a Beach on or adjacent to your
                                                    site?</label>&nbsp;&nbsp;&nbsp;
                                                <label class="radio-inline">
                                                    <input type="radio" name="beach_availability" value="1"
                                                        {{ ($hotels->beach_availability) ? 'checked' : '' }}>Yes
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="beach_availability" value="0"
                                                        {{ (!$hotels->beach_availability) ? 'checked' : '' }}>No
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Do you offer Fine Dining at your
                                                    Restaurant?</label>&nbsp;&nbsp;&nbsp;
                                                <label class="radio-inline">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Do you offer Watersports as a guest
                                                    activity?</label>&nbsp;&nbsp;&nbsp;
                                                <label class="radio-inline">
                                                    <input type="radio" name="water_sports" value="yes"
                                                        {{ ($hotels->water_sports == 'yes') ? 'checked' : '' }}>Yes
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="water_sports" value="no"
                                                        {{ ($hotels->water_sports == 'no') ? 'checked' : '' }}>No
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="diving" value="yes"
                                                        {{ ($hotels->diving == 'yes') ? 'checked' : '' }}>Yes
                                                </label>
                                                <label class="radio-inline">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="no_of_rooms" name="no_of_rooms" class="form-control isNumber"
                                                    value="{{ $hotels->no_of_rooms }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Number of Restaurants</label>
                                                <input type="text" id="no_of_restaurant" name="no_of_restaurant" class="form-control isNumber"
                                                    value="{{ $hotels->no_of_restaurant }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Number of Floors</label>
                                                <input type="text" id="no_of_floor" name="no_of_floor" class="form-control isNumber"
                                                    value="{{ $hotels->no_of_floor }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Key & Most Attractive Features offered by your property</label>
                                                <textarea class="form-control ckeditor" id="additional_information"
                                                    name="additional_information">{{ $hotels->additional_information }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12 spaDiv {{ ($hotels->spa_availability == '0') ? 'hide' : '' }}">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="spa_type">
                                                    ...
                                                    <option value="In-room spa services"
                                                        {{ ($hotels->spa_type == 'In-room spa services') ? 'selected' : '' }}>In-room spa services
                                                    </option>
                                                    <option value="In-room Massage services"
                                                        {{ ($hotels->spa_type == 'In-room Massage services') ? 'selected' : '' }}>In-room Massage
                                                        services</option>
                                                    <option value="In-room beauty treatments"
                                                        {{ ($hotels->spa_type == 'In-room beauty treatments') ? 'selected' : '' }}>In-room beauty
                                                        treatments</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 poolDiv {{ ($hotels->pool == 'no') ? 'hide' : '' }}">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="pool_type" id="pool_type">
                                                    ...
                                                    <option value="Pools" {{ ($hotels->pool_type == 'Pools') ? 'selected' : '' }}>(number) Pools
                                                    </option>
                                                    <option value="Pools with separate children’s pool"
                                                        {{ ($hotels->pool_type == 'Pools with separate children’s pool') ? 'selected' : '' }}>
                                                        (number) Pools with separate children’s pool</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12 poolDiv {{ ($hotels->pool == 'no') ? 'hide' : '' }}">
                                            ...
                                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading" role="tab" id="headingSerFa">
                                                        <h6 class="panel-title">
                                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSerFa"
                                                                aria-expanded="true" aria-controls="collapseSerFa">
                                                                <i class="more-less glyphicon glyphicon-plus"></i>
                                                                Services and Facilities
                                                            </a>
                                                        </h6>
                                                    </div>
                                                    <div id="collapseSerFa" class="panel-collapse collapse" role="tabpanel"
                                                        aria-labelledby="headingSerFa">
                                                                        ...
                                                                        <li class="col-md-4">
                                                                            <label class="checkbox-inline">
                                                                                <input class="form-check-input" type="checkbox"
                                                                                    name="service_facilities_id[]" value="{{ $sData->name }}" {{ $checked }}>
                                                                                {{ $sData->name }} <span class="form-check-sign"><span
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading" role="tab" id="headingRoFac">
                                                        <h6 class="panel-title">
                                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseRoFac"
                                                                aria-expanded="true" aria-controls="collapseRoFac">
                                                                <i class="more-less glyphicon glyphicon-plus"></i>
                                                                Room Facilities
                                                            </a>
                                                        </h6>
                                                    </div>
                                                    <div id="collapseRoFac" class="panel-collapse collapse" role="tabpanel"
                                                        aria-labelledby="headingRoFac">
                                                        <div class="panel-body">
                                                            <ul style="list-style: none;">
                                                                <?php
                                                                $checked        = '';
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="activities"
                                                    id="activities">{{ $hotels->activities }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="highlights"
                                                    id="highlights">{{ $hotels->highlights }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="addMrAtrction">
                                                ...
                                                <div class="col-md-2 attrction{{$nakey}}">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="button" class="btn btn-danger deleteMrAtrctionBtn" data-key="{{ $nakey }}"
                                                            value="Remove">
                                                    </div>
                                                </div>
                                                <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="hotelfishing"
                                                    rows="10">{{ $hotels->hotelfishing }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="provide_on_site">
                                                    <option value="yes"
                                                        {{ ($hotels->provide_on_site == 'yes') ? 'selected' : '' }}>
                                                        Yes</option>
                                                    <option value="no"
                                                        {{ ($hotels->provide_on_site == 'no') ? 'selected' : '' }}>
                                                        No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="arrange_fishing_nearby">
                                                    <option value="yes"
                                                        {{ ($hotels->arrange_fishing_nearby == 'yes') ? 'selected' : '' }}>
                                                        Yes</option>
                                                    <option value="no"
                                                        {{ ($hotels->arrange_fishing_nearby == 'no') ? 'selected' : '' }}>
                                                        No</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="hotel_policy"
                                                    id="hotel_policy">{{ $hotels->hotel_policy }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Check In Time</label>
                                                <input type="text" id="check_in" name="check_in" class="form-control time"
                                                    value="{{ $hotels->check_in }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Check Out Time</label>
                                                <input type="text" id="check_out" name="check_out" class="form-control time"
                                                    value="{{ $hotels->check_out }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Need To Know</label>
                                                <textarea class="form-control ckeditor" id="need_to_know"
                                                    name="need_to_know">{{ $hotels->need_to_know }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row hotelImageDiv">
                                        ...
                                        ?>
                                                    ...
                                                    <div class="col-md-2 roomImg<?=$rgKey?>">
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">Action</label><br />
                                                            <input type="button" class="btn btn-danger deleteMrImgBtn deleteFromDb"
