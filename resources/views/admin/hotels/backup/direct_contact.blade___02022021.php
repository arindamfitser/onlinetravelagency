            ...
            <div class="ContenedorTabla">
              <table id="myTable" class="fht-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="celda_normal"><input type="checkbox" name="check1" class="check1" value="{{ route('admin.hotels.edit', ['lang' =>'en', 'id' => $hotel->hotel_id]) }}"/></td>
                    <td class="celda_normal"><?php echo ($key+1); ?></td>
                    <td class="celda_normal"><p style="width: 200px;"><?php getHotelfield($hotel->hotel_id,'hotels_name');?></p></td>
                    <!-- ========DESTINATIONS============  -->
                    ...
                    <td class="celda_normal">{{ $hotel->state->states_name }}</td>
                    <td class="celda_normal">{{ $hotel->town }}</td>
                    <!-- ====================-- -->
                    <td class="celda_normal">@if($hotel->contact_status == 'R'){{ 1 }}@endif</td>
                    ...
                    <!-- ====================-- -->
                    <td class="celda_normal">{{ $hotel->curator_rating }}</td>
