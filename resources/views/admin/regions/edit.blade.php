      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Edit Regions
              <div class="float-right">
                <select id="sitelang" name="sitelang" class="browser-default btn-round custom-select">
                  <?php @langOption(); ?>
                </select>
                <a href="{{ route('admin.regions')}}" class="btn-sm btn-success btn-round ">
            ...
            <div class="card-body">
              ...
              ?>
              <form id="AddRegions" method="post" action="{{ route('admin.regions.update', ['lang' => $lang, 'id' => $region->id]) }}">
                {{ csrf_field() }}
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group">
                      ...
                      <input type="text" id="regions_name" name="regions_name" class="form-control" value="{{ $region->regions_name }}">
                    </div>
                    <div class="form-group">
                      <label class="bmd-label-floating">Region Status</label>
                      <select id="status" name="status" class="form-control">
                        <option value="1" @if($region->status == 1) selected @endif>Published</option>
                        <option value="2" @if($region->status == 2) selected @endif>Draft</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
