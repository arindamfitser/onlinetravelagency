      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h3 class="card-title">Add Regions
          ...
          <div class="card-body">
            ...
            <form id="AddRegions" method="post" action="{{ route('admin.regions.doadd') }}">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" id="regions_name" name="regions_name" class="form-control">
                  </div>
                  <div class="form-group">
