              ...
              <div class="row">
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="file-field">
                      <div class="z-depth-1-half mb-4">
                        ...
                        <img src="{{ Storage::disk('local')->url($testimonial->testimonials_image) }}" class="img-fluid" alt="example placeholder" width="150px" height="200px">
                        @endif
                      </div>
                      <div class="d-flex">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" id="c_order" name="c_order" class="form-control" value="{{ $testimonial->c_order }}">
                  </div>
                </div>
                <div class="col-md-2">
