        ...
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <div class="float-right">
              ...
              <a href="{{ route('admin.species')}}" class="btn-sm btn-success btn-round ">
                ...
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <select id="status" name="status" class="form-control">
                      <option value="1" @if($species->status == 1) selected @endif>Published</option>
                      <option value="2" @if($species->status == 2) selected @endif>Draft</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
