      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form id="EditCategory" method="post" action="{{ route('admin.category.update', ['id' => $roomcategory->id]) }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="{{ $roomcategory->name }}">
                  </div>   
                  <div class="form-group">
                    ...
                    <select class="form-control" id="classification_id" name="classification_id">
                      ...
                      <?php $select = ''; ?>
                        @if($cls->id == $roomcategory->classification_id)
                        <?php $select .= 'selected="selected"'; ?>
                        @endif
                        <option value="{{ $cls->id }}" <?php echo $select; ?>>{{ $cls->name }}</option>
                      @endforeach
                    </select>
                  </div>              
                </div>
