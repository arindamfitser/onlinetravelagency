                    ...
                    if(!empty(array_filter($getData))){ 
                        ...
                        if(hotelSlugExists($hotel_slug) == false){
                         ...
                         if($email !=""){
                          ...
                          $HotelContact->address = $physical_addrress;
                          $HotelContact->hotel_id = $hotel_id;
                          $HotelContact->contact_person_name = $name;
                          $HotelContact->contact_person_email = $email;
...
public function delHotelgallery(Request $request,$lang){
  ...
  public function reviews(){
    $review = Review::select('*')->leftJoin('hotels_translations', 'reviews.hotel_id', '=', 'hotels_translations.hotels_id')->leftJoin('users', 'reviews.user_id', '=', 'users.id')->get()->all();
